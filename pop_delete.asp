...
select case Mode_Type
	case "DeleteReply"
		...
		if mLev > 0 then  '## is Member
			if (chkForumModerator(Forum_ID, strDBNTFUserName) = "1") or (mLev = 1) or (mLev = 4) then '## is Allowed
				...
				Response.Write "<p class=""c""><span class=""dff hfs""><b>Reply Deleted!</b></span></p>" & strLE & _
						"<script language=""javascript1.2"">self.opener.location.reload();</script>" & strLE
			else
				Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Reply</b></p>" & strLE & _
						"<p class=""c""><span class=""dff dfs""><a href=""JavaScript:onClick=history.go(-1)"">Go Back to Re-Authenticate</a></span></p>" & strLE
			end if
		else
			Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Reply</b></p>" & strLE & _
					"<p class=""c""><span class=""dff dfs""><a href=""JavaScript:onClick=history.go(-1)"">Go Back to Re-Authenticate</a></span></p>" & strLE
	...
	case "DeleteTopic"
		...
		if mLev > 0 then  '## is Member
			if (chkForumModerator(Forum_ID, strDBNTFUserName) = "1") or (mLev = 1) or (mLev = 4) then
				...
				next
				Response.Write "<p class=""c""><span class=""dff hfs""><b>Topic Deleted!</b></span></p>" & strLE & _
						"<script language=""javascript1.2"">self.opener.location.reload();</script>" & strLE
			else
				Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Topic</b></span><br>" & strLE & _
		...
		if mLev > 0 then  '## is Member
			if mLev = 4 then
				...
				for i = 0 to ubound(delAr)
					...
					Application.UnLock
				next
				Response.Write "<p class=""c""><span class=""dff hfs""><b>Forum Deleted!</b></span></p>" & strLE & _
						"<script language=""javascript1.2"">self.opener.location.reload();</script>" & strLE
			else
				Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Forum</b></span><br>" & strLE & _
						"<br><span class=""dff dfs""><a href=""JavaScript:onClick=history.go(-1)"">Go Back to Re-Authenticate</a></span></p>" & strLE
			end if
		else
			Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Forum</b></span><br>" & strLE & _
		...
		if mLev > 0 then  '## is Member
			if mLev = 4 then
				...
				for i = 0 to ubound(delAr)
					...
					Application.UnLock
				next
				Response.Write "<p class=""c""><span class=""dff hfs""><b>Category Deleted!</b></span></p>" & strLE & _
						"<script language=""javascript1.2"">self.opener.location.reload();</script>" & strLE
			else
				Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Category</b></span><br>" & strLE & _
						"<br><span class=""dff dfs""><a href=""JavaScript:onClick=history.go(-1)"">Go Back to Re-Authenticate</a></span></p>" & strLE
			end if
		else
			Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete Category</b></span><br>" & strLE & _
	...
	case "DeleteMember"
		...
		if mLev > 0 then  '## is Member
			if mLev = 4 then
				...
				Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete a Member</b></span><br>" & strLE & _
						"<br><span class=""dff dfs""><a href=""JavaScript:onClick=history.go(-1)"">Go Back to Re-Authenticate</a></span></p>" & strLE
			end if
		else
			Response.Write "<p class=""c""><span class=""dff hfs hlfc""><b>No Permissions to Delete a Member</b></span><br>" & strLE & _
	...
	case else
		Response.Write "<p class=""c""><span class=""dff hfs"">Delete "
		select case Mode_Type
			case "Member"
		...
		Response.Write "</span></p>" & strLE & _
				"<p class=""c""><span class=""dff dfs""><b><span class=""hlfc"">NOTE:&nbsp;</span></b>"
		select case Mode_Type
			case "Member"
		...
		Response.Write """ method=""post"" id=""Form1"" name=""Form1"">" & strLE & _
				"<input type=""hidden"" name=""ARCHIVE"" value=""" & ArchiveView & """>" & strLE & _
				"<input type=""hidden"" name=""REPLY_ID"" value=""" & Reply_ID & """>" & strLE & _
		...
		if strAuthType = "db" then
			Response.Write "<tr>" & strLE & _
					...
					"<td class=""putc""><input type=""text"" maxLength=""25"" name=""User"" value=""" & chkString(strDBNTUserName,"display") & """ style=""width:150px;""></td>" & strLE & _
					"</tr>" & strLE & _
					"<tr>" & strLE & _
			...
			if strAuthType = "nt" then
				Response.Write "<tr>" & strLE & _
						...
						"<td class=""putc""><span class=""dff dfs"">" & strDBNTUserName & "</span></td>" & strLE & _
						"</tr>" & strLE
			end if
		end if
		Response.Write "<tr>" & strLE & _
