...
function extratags(fString)
	fString = doCode(fString, "[spoiler]", "[/spoiler]", "<span color=""" & CColor & """>", "</font id=""" & CColor & """>")
	extratags = fString
end function
...
'		chkBadWords(fString)
	...
	if fField_Type <> "signature" and fField_Type <> "title" then
		fString = doCode(fString, "[quote]", "[/quote]", "<blockquote id=""quote""><span class=""ffs dff"" id=""quote"">quote:<hr height=""1"" noshade id=""quote"">", "<hr height=""1"" noshade id=""quote""></font id=""quote""></blockquote id=""quote"">")
	end if
	if strAllowForumCode = "1" and fField_Type <> "signature" then
		...
		if fField_Type <> "title" then
			fString = doCode(fString, "[font=Andale Mono]", "[/font=Andale Mono]", "<span face=""Andale Mono"">", "</font id=""Andale Mono"">")
			fString = doCode(fString, "[font=Arial]", "[/font=Arial]", "<span face=""Arial"">", "</font id=""Arial"">")
			fString = doCode(fString, "[font=Arial Black]", "[/font=Arial Black]", "<span face=""Arial Black"">", "</font id=""Arial Black"">")
			fString = doCode(fString, "[font=Book Antiqua]", "[/font=Book Antiqua]", "<span face=""Book Antiqua"">", "</font id=""Book Antiqua"">")
			fString = doCode(fString, "[font=Century Gothic]", "[/font=Century Gothic]", "<span face=""Century Gothic"">", "</font id=""Century Gothic"">")
			fString = doCode(fString, "[font=Courier New]", "[/font=Courier New]", "<span face=""Courier New"">", "</font id=""Courier New"">")
			fString = doCode(fString, "[font=Comic Sans MS]", "[/font=Comic Sans MS]", "<span face=""Comic Sans MS"">", "</font id=""Comic Sans MS"">")
			fString = doCode(fString, "[font=Georgia]", "[/font=Georgia]", "<span face=""Georgia"">", "</font id=""Georgia"">")
			fString = doCode(fString, "[font=Impact]", "[/font=Impact]", "<span face=""Impact"">", "</font id=""Impact"">")
			fString = doCode(fString, "[font=Tahoma]", "[/font=Tahoma]", "<span face=""Tahoma"">", "</font id=""Tahoma"">")
			fString = doCode(fString, "[font=Times New Roman]", "[/font=Times New Roman]", "<span face=""Times New Roman"">", "</font id=""Times New Roman"">")
			fString = doCode(fString, "[font=Trebuchet MS]", "[/font=Trebuchet MS]", "<span face=""Trebuchet MS"">", "</font id=""Trebuchet MS"">")
			fString = doCode(fString, "[font=Script MT Bold]", "[/font=Script MT Bold]", "<span face=""Script MT Bold"">", "</font id=""Script MT Bold"">")
			fString = doCode(fString, "[font=Stencil]", "[/font=Stencil]", "<span face=""Stencil"">", "</font id=""Stencil"">")
			fString = doCode(fString, "[font=Verdana]", "[/font=Verdana]", "<span face=""Verdana"">", "</font id=""Verdana"">")
			fString = doCode(fString, "[font=Lucida Console]", "[/font=Lucida Console]", "<span face=""Lucida Console"">", "</font id=""Lucida Console"">")

			fString = doCode(fString, "[red]", "[/red]", "<span color=""red"">", "</font id=""red"">")
			fString = doCode(fString, "[green]", "[/green]", "<span color=""green"">", "</font id=""green"">")
			fString = doCode(fString, "[blue]", "[/blue]", "<span color=""blue"">", "</font id=""blue"">")
			fString = doCode(fString, "[white]", "[/white]", "<span color=""white"">", "</font id=""white"">")
			fString = doCode(fString, "[purple]", "[/purple]", "<span color=""purple"">", "</font id=""purple"">")
			fString = doCode(fString, "[yellow]", "[/yellow]", "<span color=""yellow"">", "</font id=""yellow"">")
			fString = doCode(fString, "[violet]", "[/violet]", "<span color=""violet"">", "</font id=""violet"">")
			fString = doCode(fString, "[brown]", "[/brown]", "<span color=""brown"">", "</font id=""brown"">")
			fString = doCode(fString, "[black]", "[/black]", "<span color=""black"">", "</font id=""black"">")
			fString = doCode(fString, "[pink]", "[/pink]", "<span color=""pink"">", "</font id=""pink"">")
			fString = doCode(fString, "[orange]", "[/orange]", "<span color=""orange"">", "</font id=""orange"">")
			fString = doCode(fString, "[gold]", "[/gold]", "<span color=""gold"">", "</font id=""gold"">")

			fString = doCode(fString, "[beige]", "[/beige]", "<span color=""beige"">", "</font id=""beige"">")
			fString = doCode(fString, "[teal]", "[/teal]", "<span color=""teal"">", "</font id=""teal"">")
			fString = doCode(fString, "[navy]", "[/navy]", "<span color=""navy"">", "</font id=""navy"">")
			fString = doCode(fString, "[maroon]", "[/maroon]", "<span color=""maroon"">", "</font id=""maroon"">")
			fString = doCode(fString, "[limegreen]", "[/limegreen]", "<span color=""limegreen"">", "</font id=""limegreen"">")
			...
			fString = doCode(fString, "[size=1]", "[/size=1]", "<span class=""size=""1"">", "</font id=""size1"">")
			fString = doCode(fString, "[size=2]", "[/size=2]", "<span class=""size=""2"">", "</font id=""size2"">")
			fString = doCode(fString, "[size=3]", "[/size=3]", "<span class=""size=""3"">", "</font id=""size3"">")
			fString = doCode(fString, "[size=4]", "[/size=4]", "<span class=""size=""4"">", "</font id=""size4"">")
			fString = doCode(fString, "[size=5]", "[/size=5]", "<span class=""size=""5"">", "</font id=""size5"">")
			fString = doCode(fString, "[size=6]", "[/size=6]", "<span class=""size=""6"">", "</font id=""size6"">")
			...
			'fString = doCode(fString, "[code]", "[/code]", "<pre id=""code""><span face=""courier"" class=""dfs"" id=""code"">", "</font id=""code""></pre id=""code"">")
...
Function ReplaceCodeTags(fString)
 	...
 	CodeTags(1,1,1) = "[code]"
 	CodeTags(1,2,1) = "[/code]"
 	CodeTags(1,1,2) = "<pre id=""code""><span face=""courier"" class=""dfs"" id=""code"">"
...
Function TopSQL(strSQL, lngRecords)
	if ucase(left(strSQL,7)) = "SELECT " then
 		select case strDBType 
			case "sqlserver"
				TopSQL = "SET ROWCOUNT " & lngRecords & strLE & strSQL & strLE & "SET ROWCOUNT 0"
			case "access"
...
function profileLink(fName, fID)
	if instr(fName,"img src=") > 0 then
		...
		strExtraStuff = " title=""View " & fName & "'s Profile"""
	end if
