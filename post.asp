...
Response.Write "<script type=""text/javascript"" src=""inc_code.js""></script>" & strLE & _
		"<script type=""text/javascript"" src=""selectbox.js""></script>" & strLE
...
strRqMethod = "ReplyQuote" then
	...
	if strRqMethod = "Edit" then
		...
		if strRqMethod = "ReplyQuote" then
			TxtMsg = "[quote][i]Originally posted by " & chkString(rs("M_NAME"),"display") & "[/i]" & strLE
			TxtMsg = TxtMsg & "[br]" & rs("R_MESSAGE") & strLE
			TxtMsg = TxtMsg & "[/quote]"
		end if
	end if
	set rs = nothing
...
if strRqMethod = "EditTopic" or strRqMethod = "TopicQuote" then
	...
	if strRqMethod = "EditTopic" then
		...
		if strRqMethod = "TopicQuote" then
			TxtMsg = "[quote][i]Originally posted by " & chkString(rs("M_NAME"),"display") & "[/i]" & strLE
			TxtMsg = TxtMsg & "[br]" & rs("T_MESSAGE") & strLE
			TxtMsg = TxtMsg & "[/quote]"
		end if
	end if
	set rs = nothing
...
Response.Write "<table class=""tc"" width=""100%"">" & strLE & _
		"<tr>" & strLE & _
		"<td class=""l"" width=""33%""><span class=""dff dfs"">" & strLE & _
		getCurrentIcon(strIconFolderOpen,"","class=""vam""") & "&nbsp;<a href=""default.asp"">" & chkString(strForumTitle,"pagetitle") & "</a><br>" & strLE
if strRqMethod = "EditCategory" then
	Response.Write getCurrentIcon(strIconBar,"","class=""vam""") & getCurrentIcon(strIconFolderOpen,"","class=""vam""") & "&nbsp;" & ChkString(TxtSub,"display") & "<br>" & strLE
elseif strRqMethod = "EditForum" or strRqMethod = "EditURL" then
	Response.Write getCurrentIcon(strIconBar,"","class=""vam""") & getCurrentIcon(strIconFolderOpen,"","class=""vam""") & "&nbsp;<a href=""default.asp?CAT_ID=" & strRqCatID & """>" & ChkString(strCatName,"display") & "</a><br>" & strLE
	Response.Write getCurrentIcon(strIconBlank,"","class=""vam""") & getCurrentIcon(strIconBar,"","class=""vam""") & getCurrentIcon(strIconFolderOpen,"","class=""vam""") & "&nbsp;" & ChkString(TxtSub,"display") & "<br>" & strLE
else
	...
	strRqMethod = "Topic" or strRqMethod = "TopicQuote" then
		Response.Write getCurrentIcon(strIconBar,"","class=""vam""")
		...
		Response.Write "&nbsp;<a href=""default.asp?CAT_ID=" & strRqCatId & """>" & ChkString(Cat_Name,"display") & "</a><br>" & strLE
		Response.Write getCurrentIcon(strIconBlank,"","class=""vam""") & getCurrentIcon(strIconBar,"","class=""vam""")
		...
		Response.Write "&nbsp;<a href=""forum.asp?FORUM_ID=" & strRqForumId & """>" & ChkString(Forum_Subject,"display") & "</a><br>" & strLE
	end if
 end if
...
strRqMethod = "Reply" or strRqMethod = "ReplyQuote" or _
strRqMethod = "TopicQuote" then
	Response.Write getCurrentIcon(strIconBlank,"","class=""vam""") & getCurrentIcon(strIconBlank,"","class=""vam""") & getCurrentIcon(strIconBar,"","class=""vam""")
	if blnTStatus <> 0 and blnFStatus <> 0 and blnCStatus <> 0 then
		Response.Write getCurrentIcon(strIconFolderOpenTopic,"","class=""vam""")
	else
		Response.Write getCurrentIcon(strIconFolderClosedTopic,"","class=""vam""")
	end if
	Response.Write "&nbsp;<a href=""topic.asp?TOPIC_ID=" & strRqTopicID & """>" & ChkString(Topic_Title,"title") & "</a>" & strLE
end if
Response.Write "</span></td>" & strLE & _
		"</tr>" & strLE & _
		"</table>" & strLE & _
		"<p class=""c""><span class=""dff dfs"">" & Msg & "</span></p>" & strLE & _
...
Response.Write ">" & strLE & _
		...
		"<input name=""Method_Type"" type=""hidden"" value=""" & strRqMethod & """>" & strLE & _
		"<input name=""REPLY_ID"" type=""hidden"" value=""" & strRqReplyID & """>" & strLE & _
		"<input name=""TOPIC_ID"" type=""hidden"" value=""" & strRqTopicID & """>" & strLE & _
		"<input name=""FORUM_ID"" type=""hidden"" value=""" & strRqForumId & """> " & strLE & _
		"<input name=""CAT_ID"" type=""hidden"" value=""" & strRqCatID & """>" & strLE
if strRqMethod = "Edit" or strRqMethod = "EditTopic" then Response.Write("<input name=""Author"" type=""hidden"" value=""" & strAuthor & """>" & strLE)
Response.Write "<input name=""Refer"" type=""hidden"" value=""" & strReferer & """>" & strLE & _
		"<input name=""cookies"" type=""hidden"" value=""yes"">" & strLE

if strRqMethod = "Edit" or strRqMethod = "EditTopic" or strRqMethod = "Forum" or strRqMethod = "EditForum" or _
	strRqMethod = "Reply" or strRqMethod = "ReplyQuote" or _
	strRqMethod = "Topic" or strRqMethod = "TopicQuote" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Screensize:</b></span></td>" & strLE & _
			"<td class=""putc""><span class=""dff dfs"">" & strLE & _
			"<select name=""SelectSize"" size=""1"" onchange=""resizeTextarea('" & strUniqueID & "')"">" & strLE & _
			"                	<option value=""1"""
	if strSelectSize = "1" then Response.Write(" selected")
	Response.Write ">640  x 480</option>" & strLE & _
			"                	<option value=""2"""
	if strSelectSize = "2" or strSelectSize = "" then Response.Write(" selected")
	Response.Write ">800  x 600</option>" & strLE & _
			"                	<option value=""3"""
	if strSelectSize = "3" then Response.Write(" selected")
	Response.Write ">1024 x 768</option>" & strLE & _
			"                	<option value=""4"""
	if strSelectSize = "4" then Response.Write(" selected")
	Response.Write ">1280 x 1024</option>" & strLE & _
			"</select>" & strLE & _
			"</span></td>" & strLE & _
			"</tr>" & strLE
end if
...
mlev = 2 or _
mlev = 1 then
	Response.Write "<input name=""UserName"" type=""hidden"" value=""" & strDBNTUserName & """>" & strLE & _
			"<input name=""Password"" type=""hidden"" value=""" & strCkPassWord & """>" & strLE
else
	if (lcase(strNoCookies) = "1") or _
	(strDBNTUserName = "" or _
	strCkPassWord = "") then
		Response.Write "<tr>" & strLE & _
				"<td class=""putc vat nw r""><span class=""dff dfs""><b>UserName:</b></span></td>" & strLE & _
				"<td class=""putc""><input name=""UserName"" maxLength=""25"" size=""25"" type=""text"" value=""" & Request.Form("UserName") & """></td>" & strLE & _
				"</tr>" & strLE & _
				"<tr>" & strLE & _
				"<td class=""putc vat nw r""><span class=""dff dfs""><b>Password:</b></span></td>" & strLE & _
				"<td class=""putc vat""><input name=""Password"" maxLength=""25"" size=""25"" type=""password"" value=""" & Request.Form("password") & """></td>" & strLE & _
				"</tr>" & strLE
	end if
end if
...
strRqMethod = "EditForum" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Category:</b></span></td>" & strLE & _
			"<td class=""putc"">" & strLE & _
			"<select name=""Category"" size=""1"">" & strLE
	'## Forum_SQL
	...
	if recCatCount <> "" then
		...
		for iCat = 0 to recCatCount
			...
			Response.Write ">" & ChkString(CatName,"display") & "</option>" & strLE
		next
	end if
	Response.Write "</select>" & strLE & _
			"<a href=""Javascript:openWindow3('pop_help.asp?mode=options#category')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
			"</tr>" & strLE
end if
...
if (strRqMethod = "EditTopic") then
	...
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Forum:</b></span></td>" & strLE & _
			"<td class=""putc"">" & strLE
	if (mlev = 3 or mlev = 4) and ArchiveView <> "true" then
		Response.Write "<select name=""Forum"" size=""1"">" & strLE
	end if
	'## Forum_SQL
	...
	if (mlev = 3 or mlev = 4) and ArchiveView <> "true" then
		if recForumCount <> "" then
			...
			for iForum = 0 to recForumCount
				...
				if ChkDisplayForum(ForumPrivateForums,ForumFPasswordNew,ForumID,MemberID) then
					...
					Response.Write 	">" & ChkString(ForumSubject,"display") & "</option>" & strLE
				end if
			next
		end if
	else
		...
		Response.Write 	"<span class=""dff dfs"">" & ChkString(ForumSubject,"display") & "</span>" & strLE & _
				"<input type=""hidden"" name=""Forum"" value=""" & ForumCatID & "|" & ForumID & """>" & strLE
	end if
...
strRqMethod = "EditForum" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Default Days:</b></span></td>" & strLE & _
			"<td class=""putc""><select name=""DefaultDays"" size=""1"">" & strLE & _
			"                	<option value=""0"""
	if fDefaultDays = "0" then Response.Write(" SELECTED")
	Response.Write ">Show all topics</option>" & strLE & _
			"                	<option value=""-1"""
	if fDefaultDays = "-1" then Response.Write(" SELECTED")
	Response.Write ">Show all open topics</option>" & strLE & _
			"                	<option value=""1"""
	if fDefaultDays = "1" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last day</option>" & strLE & _
			"                	<option value=""2"""
	if fDefaultDays = "2" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 2 days</option>" & strLE & _
			"                	<option value=""5"""
	if fDefaultDays = "5" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 5 days</option>" & strLE & _
			"                	<option value=""7"""
	if fDefaultDays = "7" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 7 days</option>" & strLE & _
			"                	<option value=""14"""
	if fDefaultDays = "14" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 14 days</option>" & strLE & _
			"                	<option value=""30"""
	if fDefaultDays = "30" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 30 days</option>" & strLE & _
			"                	<option value=""60"""
	if fDefaultDays = "60" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 60 days</option>" & strLE & _
			"                	<option value=""120"""
	if fDefaultDays = "120" then Response.Write(" SELECTED")
	Response.Write ">Show topics from last 120 days</option>" & strLE & _
			"                	<option value=""365"""
	if fDefaultDays = "365" then Response.Write(" SELECTED")
	Response.Write ">Show topics from the last year</option>" & strLE & _
			"</select>" & strLE & _
			"<a href=""Javascript:openWindow3('pop_help.asp?mode=options#defaultdays')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
			"</tr>" & strLE
end if
...
strRqMethod = "EditForum" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Increase Post Count:</b></span></td>" & strLE & _
			"<td class=""putc""><select name=""ForumCntMPosts"" size=""1"">" & strLE & _
			"                	<option value=""0"""
	...
	Response.Write ">Yes</option>" & strLE & _
			"</select>" & strLE & _
			"<a href=""Javascript:openWindow3('pop_help.asp?mode=options#forumcntmposts')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
			"</tr>" & strLE
end if
...
strRqMethod = "Topic" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Subject:</b></span></td>" & strLE & _
			"<td class=""putc""><input maxLength=""50"" name=""Subject"" value=""" & Trim(ChkString(TxtSub,"edit")) & """ size=""40""></td>" & strLE & _
			"</tr>" & strLE & _
			"<script type=""text/javascript"">document.PostTopic.Subject.focus();</script>" & strLE
end if

if strRqMethod = "URL" or _
strRqMethod = "EditURL" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Address:</b></span></td>" & strLE & _
			"<td class=""putc""><input maxLength=""150"" name=""Address"" value="""
	if (TxtURL <> "") then Response.Write(TxtURL) else Response.Write("http://")
	Response.Write """ size=""40""><a href=""Javascript:openWindow3('pop_help.asp?mode=options#address')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
			"</tr>" & strLE
end if
...
strRqMethod = "EditTopic" or strRqMethod = "Topic" or strRqMethod = "TopicQuote" then
	Response.Write "<tr>" & strLE & _
			"<td class=""putc vat nw r""><span class=""dff dfs""><b>Message:</b><br>" & strLE & _
			"<br>" & strLE & _
			"<table>" & strLE & _
			"<tr>" & strLE & _
			"<td class=""nw l""><span class=""dff dfs"">" & strLE
...
<%
	...
	Response.Write "</span></td>" & strLE & _
			...
			"</table>" & strLE & _
			"</span></td>" & strLE & _
			"<td class=""putc""><textarea cols=""" & intCols & """ name=""Message"" rows=""" & intRows & """ wrap=""VIRTUAL"" onselect=""storeCaret(this);"" onclick=""storeCaret(this);"" onkeyup=""storeCaret(this);"" onchange=""storeCaret(this);"">" & Trim(CleanCode(TxtMsg)) & "</textarea><br></td>" & strLE & _
			"</tr>" & strLE
end if
select case strRqMethod
	case "Reply", "ReplyQuote", "TopicQuote"
		Response.Write "<script type=""text/javascript"">document.PostTopic.Message.focus();</script>" & strLE
end select
...
strRqMethod = "EditForum") and (mLev > 3 or lcase(strNoCookies) = "1") then
	Response.Write "<tr>" & strLE & _
		      	"<td class=""putc vat nw r""><span class=""dff dfs""><b>Moderators:</b></span></td>" & strLE
	...
	SelectSize = 6
	Response.Write "<td class=""putc"">" & strLE & _
			"<table>" & strLE & _
			"<tr>" & strLE & _
			"<td class=""c""><span class=""dff dfs""><b>Available</b></span><br>" & strLE & _
			"<select name=""ForumModCombo"" size=""" & SelectSize & """ multiple onDblClick=""moveSelectedOptions(document.PostTopic.ForumModCombo, document.PostTopic.ForumMod, true, '')"">" & strLE
	'## Pick from list
	...
	Response.Write "</select>" & strLE & _
			...
			"<a href=""javascript:moveAllOptions(document.PostTopic.ForumMod, document.PostTopic.ForumModCombo, true, '')"">" & getCurrentIcon(strIconPrivateRemAll,"","") & "</a>" & strLE & _
			"<a href=""javascript:moveSelectedOptions(document.PostTopic.ForumMod, document.PostTopic.ForumModCombo, true, '')"">" & getCurrentIcon(strIconPrivateRemove,"","") & "</a>" & strLE & _
			"<a href=""javascript:moveSelectedOptions(document.PostTopic.ForumModCombo, document.PostTopic.ForumMod, true, '')"">" & getCurrentIcon(strIconPrivateAdd,"","") & "</a>" & strLE & _
			"<a href=""javascript:moveAllOptions(document.PostTopic.ForumModCombo, document.PostTopic.ForumMod, true, '')"">" & getCurrentIcon(strIconPrivateAddAll,"","") & "</a>" & strLE & _
			"</td>" & strLE & _
			"<td class=""c""><span class=""dff dfs""><b>Selected</b></span><br>" & strLE & _
			"<select name=""ForumMod"" size=""" & SelectSize & """ multiple onDblClick=""moveSelectedOptions(document.PostTopic.ForumMod, document.PostTopic.ForumModCombo, true, '')"">" & strLE
	'## Selected List
	if strRqMethod = "EditForum" or strRqMethod = "EditURL" then
		if recForumModeratorCount <> "" then
			for iForumModerator = 0 to recForumModeratorCount
				...
				if ForumModeratorMemberID <> "" then
					Response.Write 	"                      		<option value=""" & ForumModeratorMemberID & """>" & ForumModeratorMemberName & "</option>" & strLE
				end if
			next
		end if
	end if
	Response.Write "</select>" & strLE & _
			"</td>" & strLE & _
			"<td class=""vat"">&nbsp;<a href=""Javascript:openWindow3('pop_help.asp?mode=options#moderators')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
			"</tr>" & strLE & _
			"</table>" & strLE & _
			"</td>" & strLE & _
			"</tr>" & strLE
...
strRqMethod = "Category" or strRqMethod = "EditCategory" then
	...
	((strRqMethod = "Forum" or strRqMethod = "EditForum") and (CatSubscription > 0))) then
		...
		Response.Write 	"<td class=""putc vat nw r""><span class=""dff dfs""><b>Subscription:</b></span></td>" & strLE
		Response.Write 	"<td class=""putc vat nw""><span class=""dff dfs"">" & strLE
		Response.Write 	"<select name=""Subscription"">" & strLE
		if strRqMethod = "Category" or strRqMethod = "EditCategory" then
			Response.Write 	"                	<option"
			if CatSubscription = 0 then
				Response.Write 	" selected "
			end if
			Response.Write " value=""0"">No Subscriptions Allowed</option>" & strLE
			...
			if strSubscription < 3 then
				...
				Response.Write 	" value=""1"">Category Subscriptions Allowed</option>" & strLE
			end if
			...
			if strSubscription < 4 then
				...
				Response.Write 	" value=""2"">Forum Subscriptions Allowed</option>" & strLE
			end if
			Response.Write 	"                	<option"
			if CatSubscription = 3 then
				Response.Write 	" selected "
			end if
			Response.Write 	" value=""3"">Topic Subscriptions Allowed</option>" & strLE
		else
			Response.Write 	"                	<option"
			...
			if strSubscription < 4 and CatSubscription < 3 then
				...
				Response.Write 	" value=""1"">Forum Subscriptions Allowed</option>" & strLE
			end if
			Response.Write 	"                	<option"
			if ForumSubscription = 2 then
				Response.Write 	" selected "
			end if
			Response.Write 	" value=""2"">Topic Subscriptions Allowed</option>" & strLE
		end if
		Response.Write 	"</select>" & strLE
		Response.Write 	"<a href=""Javascript:openWindow3('pop_help.asp?mode=options#subscription')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></span></td>" & strLE
		Response.Write "</tr>" & strLE
	end if
	...
	((strRqMethod = "Forum"   or strRqMethod = "EditForum") and CatModeration > 0)) then
   		Response.Write 	"<tr>" & strLE
	   	Response.Write 	"<td class=""putc vat nw r""><span class=""dff dfs""><b>Moderation:</b></span></td>" & strLE
		Response.Write 	"<td class=""putc vat nw""><span class=""dff dfs"">" & strLE
		Response.Write 	"<select name=""Moderation"">" & strLE
		if strRqMethod = "Category" or strRqMethod = "EditCategory" then
			Response.Write 	"                	<option"
			if CatModeration = 0 then
				Response.Write 	" selected "
			end if
			Response.Write 	" value=""0"">Moderation Not Allowed in this Category</option>" & strLE
			Response.Write 	"                	<option"
			if CatModeration = 1 then
				Response.Write 	" selected "
			end if
			Response.Write 	" value=""1"">Moderation Allowed in this Category</option>" & strLE
   		else
			Response.Write 	"                	<option"
	      		if ForumModeration = 0 then
		     		Response.Write 	" selected "
	  		end if
	  		Response.Write 	" value=""0"">No Moderation for this forum</option>" & strLE
			Response.Write 	"                	<option"
      			if ForumModeration = 1 then
		     		Response.Write 	" selected "
	  		end if
	  		Response.Write 	" value=""1"">All Posts Moderated</option>" & strLE
			Response.Write 	"                	<option"
      			if ForumModeration = 2 then
	     			Response.Write 	" selected "
	  		end if
	  		Response.Write 	" value=""2"">Original Posts Only Moderated</option>" & strLE
			Response.Write 	"                	<option"
	      		if ForumModeration = 3 then
		     		Response.Write 	" selected "
	  		end if
	  		Response.Write 	" value=""3"">Replies Only Moderated</option>" & strLE
   		end if
   		Response.Write 	"</select>" & strLE
   		Response.Write 	"<a href=""Javascript:openWindow3('pop_help.asp?mode=options#moderation')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a>&nbsp;</span></td>" & strLE
   		Response.Write 	"</tr>" & strLE
	end if
end if
...
strRqMethod = "EditTopic" or strRqMethod = "Topic" or strRqMethod = "TopicQuote" then
	...
	strRqMethod = "Topic" or strRqMethod = "EditTopic" or strRqMethod = "TopicQuote" then
		...
		strRqMethod = "Topic" or strRqMethod = "TopicQuote") and strSignatures = "1" and strDSignatures <> "1" then
			Response.Write "<span class=""dff dfs"">" & strLE
		        intSigDefault = getSigDefault(MemberID)
		        Response.Write "<input name=""Sig"" id=""Sig"" type=""checkbox"" value=""yes""" & chkCheckbox(intSigDefault,1,true) & "><label for=""Sig"">Check here to include your profile signature.</label><br></span>" & strLE
		end if
		if strSignatures = "1" and strDSignatures = "1" then
	        	Response.Write "<span class=""dff dfs"">"
			if strRqMethod = "Edit" then
			        Response.Write "<input name=""Sig"" id=""Sig"" type=""checkbox"" value=""yes""" & chkCheckbox(strReplySig,1,true) & "><label for=""Sig"">Check here to include your profile signature.</label><br></span>" & strLE
        		elseif strRqMethod = "EditTopic" then
	        		Response.Write "<input name=""Sig"" id=""Sig"" type=""checkbox"" value=""yes""" & chkCheckbox(strTopicSig,1,true) & "><label for=""Sig"">Check here to include your profile signature.</label><br></span>" & strLE
			else
			        intSigDefault = getSigDefault(MemberID)
			        Response.Write "<input name=""Sig"" id=""Sig"" type=""checkbox"" value=""yes""" & chkCheckbox(intSigDefault,1,true) & "><label for=""Sig"">Check here to include your profile signature.</label><br></span>" & strLE
			end if
		...
		if strSubscription > 0 and postCat_Subscription > 0 and postForum_Subscription > 0 and strEmail = 1 then
			...
			SubLinkFontStart = "<span class=""dff dfs"">"
			SubLinkFontEnd = "<br></span>" & strLE
		...
		strRqMethod = "ReplyQuote" or strRqMethod = "TopicQuote") then
			if strStickyTopic = "1" then
				if strRqMethod = "Topic" then
					Response.Write "<span class=""dff dfs""><input name=""sticky"" id=""sticky"" type=""checkbox"" value=""1""><label for=""sticky"">Check here to make this topic sticky.</label><br></span>" & strLE
				elseif strRqMethod = "EditTopic" then
					Response.Write "<span class=""dff dfs""><input name=""sticky"" id=""sticky"" type=""checkbox"" value=""1""" & chkCheckbox(strTopicSticky,1,true) & "><label for=""sticky"">Check here to make this topic sticky.</label><br></span>" & strLE
				end if
			end if
			if blnTStatus = 1 then
				if strRqMethod <> "EditTopic" then
					Response.Write "<span class=""dff dfs""><input name=""lock"" id=""lock"" type=""checkbox"" value=""1""><label for=""lock"">Check here to lock the topic after this post.</label><br></span>" & strLE
				end if
			end if
		end if
...
if strPrivateForums <> "0" then
	...
	strRqMethod = "EditForum" then
		...
		Response.Write "<tr>" & strLE & _
				"<td class=""putc vat nw r""><span class=""dff dfs""><b>Auth Type:</b></span></td>" & strLE & _
				"<td class=""putc"">" & strLE & _
				"<select readonly name=""AuthType"">" & strLE & _
				"                	<option value=""0"""
		if ForumAuthType = 0 then Response.Write(" selected")
		Response.Write ">All Visitors</option>" & strLE
		if strRqMethod = "Forum" or strRqMethod = "EditForum" then
			Response.Write "                	<option value=""4"""
			if ForumAuthType = 4 then Response.Write(" selected")
			Response.Write ">Members Only</option>" & strLE
		end if
		Response.Write "                	<option value=""5"""
		if ForumAuthType = 5 then Response.Write(" selected")
		Response.Write ">Members Only (Hidden)</option>" & strLE
		if strRqMethod = "Forum" or _
		strRqMethod = "EditForum" then
			Response.Write "                	<option value=""2"""
			if ForumAuthType = 2 then Response.Write(" selected")
			Response.Write ">Password Protected</option>" & strLE & _
					"                	<option value=""7"""
			if ForumAuthType = 7 then Response.Write(" selected")
			Response.Write ">Members Only & Password Protected</option>" & strLE & _
					"                	<option value=""3"""
			if ForumAuthType = 3 then Response.Write(" selected")
			Response.Write ">Allowed Member List & Password Protected</option>" & strLE & _
					"                	<option value=""1"""
			if ForumAuthType = 1 then Response.Write(" selected")
			Response.Write ">Allowed Member List</option>" & strLE
		end if
		Response.Write "                	<option value=""6"""
		if ForumAuthType = 6 then Response.Write(" selected")
		Response.Write ">Allowed Member List (Hidden)</option>" & strLE
		if strNTGroups = "1" then
			Response.Write "                	<option value=""9"""
			if ForumAuthType = 9 then Response.Write(" selected")
			Response.Write ">NT Global Group</option>" & strLE & _
					"                	<option value=""8"""
			if ForumAuthType = 8 then Response.Write(" selected")
			Response.Write ">NT Global Group (Hidden)</option>" & strLE
		end if
		Response.Write "</select>&nbsp;<a href=""Javascript:openWindow3('pop_help.asp?mode=options#authtype')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a>" & strLE
		if strRqMethod = "Forum" or _
		strRqMethod = "EditForum" then
			if strRqMethod = "EditForum" then
			...
			Response.Write "<br><span class=""dff dfs""><b>Password"
			if strNTGroups = "1" then Response.Write(" or Global Groups")
			Response.Write ":</b><br></span>" & strLE & _
					"<input maxLength=""255"" type=""text"" name=""AuthPassword"" size=""50"" value=""" & strPassword & """>"
		end if
		Response.Write "</td>" & strLE & _
				"</tr>" & strLE & _
				"<tr>" & strLE & _
				"<td class=""putc vat nw r""><span class=""dff dfs""><b>Allowed Member List:</b></span></td>" & strLE
		'#################################################################################
		...
		Response.Write "<td class=""putc"">" & strLE & _
				...
				"<tr>" & strLE & _
				"<td class=""c""><span class=""dff dfs""><b>Available</b></span><br>" & strLE & _
				"<select name=""AuthUsersCombo"" size=""" & SelectSize & """ multiple onDblClick=""moveSelectedOptions(document.PostTopic.AuthUsersCombo, document.PostTopic.AuthUsers, false, '')"">" & strLE
		'## Pick from list
		...
		Response.Write "</select>" & strLE & _
				"</td>" & strLE & _
				"<td class=""vam c"" width=""15""><br>" & strLE & _
				"<a href=""javascript:moveAllOptions(document.PostTopic.AuthUsers, document.PostTopic.AuthUsersCombo, false, '')"">" & getCurrentIcon(strIconPrivateRemAll,"","") & "</a>" & strLE & _
				"<a href=""javascript:moveSelectedOptions(document.PostTopic.AuthUsers, document.PostTopic.AuthUsersCombo, false, '')"">" & getCurrentIcon(strIconPrivateRemove,"","") & "</a>" & strLE & _
				"<a href=""javascript:moveSelectedOptions(document.PostTopic.AuthUsersCombo, document.PostTopic.AuthUsers, false, '')"">" & getCurrentIcon(strIconPrivateAdd,"","") & "</a>" & strLE & _
				"<a href=""javascript:moveAllOptions(document.PostTopic.AuthUsersCombo, document.PostTopic.AuthUsers, false, '')"">" & getCurrentIcon(strIconPrivateAddAll,"","") & "</a>" & strLE & _
				"</td>" & strLE & _
				"<td class=""c""><span class=""dff dfs""><b>Selected</b></span><br>" & strLE & _
				"<select name=""AuthUsers"" size=""" & SelectSize & """ multiple onDblClick=""moveSelectedOptions(document.PostTopic.AuthUsers, document.PostTopic.AuthUsersCombo, false, '')"">" & strLE
		'## Selected List
		if strRqMethod = "EditForum" or strRqMethod = "EditURL" then
			if recAllowedMemberCount <> "" then
				for iAllowedMember = 0 to recAllowedMemberCount
					...
					if AllowedMembersMemberID <> "" then
						Response.Write 	"                      		<option value=""" & AllowedMembersMemberID & """>" & AllowedMembersMemberName & "</option>" & strLE
					end if
				next
			end if
		end if
		Response.Write "</select>" & strLE & _
				"</td>" & strLE & _
				"<td class=""vat"">&nbsp;<a href=""Javascript:openWindow3('pop_help.asp?mode=options#memberlist')"">" & getCurrentIcon(strIconSmileQuestion,"Click here to get more help on this option","") & "</a></td>" & strLE & _
				"</tr>" & strLE & _
				"</table>" & strLE & _
				"</td>" & strLE & _
				"</tr>" & strLE
...
Response.Write "<tr>" & strLE & _
		"<td class=""putc"">&nbsp;</td>" & strLE & _
		"<td class=""putc""><input name=""Submit"" type=""submit"" value=""" & btn & """"
if strRqMethod = "Forum" or _
strRqMethod = "URL" or _
strRqMethod = "EditURL" or _
strRqMethod = "EditForum" then
...
'Response.Write "&nbsp;<input name=""Reset"" type=""reset"" value=""Reset Fields""></td>" & strLE & _
Response.Write "</td>" & strLE & _
		"</tr>" & strLE & _
		"</form>" & strLE & _
		"</table>" & strLE & _
...
strRqMethod = "ReplyQuote" then
	Response.Write "</td>" & strLE & _
			...
			"<tr>" & strLE & _
			"<td class=""hcc c"" colspan=""2""><b><span class=""dff ffs hfc"">T O P I C&nbsp;&nbsp;&nbsp;&nbsp;R E V I E W</span></b></td>" & strLE & _
			"</tr>" & strLE
	if (mLev = 4) or (chkForumModerator(strRqForumId, strDBNTUserName) = "1") then
		Moderation = "N"
	else
	...
	Response.Write "<tr>" & strLE
	Response.Write "<td class=""ffcc vat"" width=""" & strTopicWidthLeft & """"
	if lcase(strTopicNoWrapLeft) = "1" then
		Response.Write " nowrap"
	end if
	Response.Write "><span class=""ffc dff dfs""><b>" & ChkString(rs("M_NAME"),"display") & "</b></span></td>" & strLE
	Response.Write "<td class=""ffcc vat"" width=""" & strTopicWidthRight & """"
	if lcase(strTopicNoWrapRight) = "1" then
		Response.Write " nowrap"
	end if
	Response.Write "><span class=""ffc dff dfs""><small>Posted&nbsp;-&nbsp;" & ChkDate(rs("T_DATE"), "&nbsp;:" ,true) & "</small><hr class=""ffs""><span class=""smt"">" & formatStr(rs("T_MESSAGE")) & "</span></span></td>" & strLE
	Response.Write "</tr>" & strLE
	...
	if recReplyCount = "" then
		...
		Response.Write "<tr>" & strLE & _
				"<td class=""hcc c"" colspan=""2""><b><span class=""dff ffs hfc"">" & recReplyCount+1 & "&nbsp;&nbsp;&nbsp;L A T E S T&nbsp;&nbsp;&nbsp;&nbsp;R E P L I E S&nbsp;&nbsp;&nbsp;&nbsp;(Newest First)</span></b></td>" & strLE & _
				"</tr>" & strLE
		...
		for iReply = 0 to recReplyCount
			...
			Response.Write 	"<tr>" & strLE & _
					"<td class=""vat"" bgcolor=""" & CColor & """ " & strLE
			if lcase(strTopicNoWrapLeft) = "1" then
				Response.Write " nowrap"
			end if
			Response.Write 	"><b><span class=""ffc dff dfs"">" &  ChkString(ReplyMemberName,"display") & "</span></b></td>" & strLE & _
					"<td class=""vat"" bgcolor=""" & CColor & """ "
			if lcase(strTopicNoWrapRight) = "1" then
				Response.Write " nowrap"
			end if
			Response.Write 	"><span class=""ffc dff dfs""><small>Posted&nbsp;-&nbsp;" & ChkDate(ReplyDate, "&nbsp;:" ,true) & "</small><hr class=""ffs""><span class=""smt"">" & formatStr(ReplyMessage) & "</span></span></td>" & strLE & _
					"</tr>" & strLE
			strI = strI + 1
			if strI = 2 then
				strI = 0
...
function Go_Result(message)
	Response.write 	"<br><div class=""c""><span class=""dff dfs hlfc"">" & message & "</span></div>" &_
			"<br>" &_
