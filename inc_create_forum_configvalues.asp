...
strDummy = SetConfigValue(1,"STRCOPYRIGHT","2000-08 Snitz Communications")
...
strDummy = SetConfigValue(1,"STRACTIVETEXTDECORATION","underline")
...
strDummy = SetConfigValue(1,"STRMINAGE","13")
...
strDummy = SetConfigValue(1,"STRIMAGEURL", "images/")
...
strDummy = SetConfigValue(1,"STRREQAIM","0")
strDummy = SetConfigValue(1,"STRREQICQ","0")
strDummy = SetConfigValue(1,"STRREQMSN","0")
strDummy = SetConfigValue(1,"STRREQYAHOO","0")
strDummy = SetConfigValue(1,"STRREQFULLNAME","0")
strDummy = SetConfigValue(1,"STRREQPICTURE","0")
strDummy = SetConfigValue(1,"STRREQCITY","0")
strDummy = SetConfigValue(1,"STRREQSTATE","0")
strDummy = SetConfigValue(1,"STRREQAGE","0")
strDummy = SetConfigValue(1,"STRREQAGEDOB","0")
strDummy = SetConfigValue(1,"STRREQHOMEPAGE","0")
strDummy = SetConfigValue(1,"STRREQCOUNTRY","0")
strDummy = SetConfigValue(1,"STRREQOCCUPATION","0")
strDummy = SetConfigValue(1,"STRREQBIO","0")
strDummy = SetConfigValue(1,"STRREQHOBBIES","0")
strDummy = SetConfigValue(1,"STRREQLNEWS","0")
strDummy = SetConfigValue(1,"STRREQQUOTE","0")
strDummy = SetConfigValue(1,"STRREQMARSTATUS","0")
strDummy = SetConfigValue(1,"STRREQFAVLINKS","0")
strDummy = SetConfigValue(1,"INTMAXPOSTSTOEMAIL","10")
strDummy = SetConfigValue(1,"STRNOMAXPOSTSTOEMAIL","You do not have enough posts to email other members. If you feel that you have received this message in error, please contact the forum administrator.")
strDummy = SetConfigValue(1,"STRFILTEREMAILADDRESSES","0")
%>
