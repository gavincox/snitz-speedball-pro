...
sub DisplayIP()
	...
	if usr = 1 then
		...
		set rsIP = nothing
		Response.Write "<p class=""c""><b>User's IP address:</b><br><a href=""" & strIPLookup & ip & """ target=""_blank"">" & ip & "</a></p>" & strLE
	else
		Response.Write "<p class=""c""><b>Only moderators and administrators can perform this action.</b></p>" & strLE
	end If
end sub
%>
